...
{
    register_taxonomy_for_object_type('category', 'home-page-post'); // Register Taxonomies for Category
    register_taxonomy_for_object_type('post_tag', 'home-page-post');
    register_post_type('home-page-post', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Home Page Post', 'home-page-post'), // Rename these to suit
            'singular_name' => __('Home Page Post', 'home-page-post'),
            'add_new' => __('Add New', 'home-page-post'),
            'add_new_item' => __('Add New Home Page Post', 'home-page-post'),
            'edit' => __('Edit', 'home-page-post'),
            'edit_item' => __('Edit Home Page Post', 'home-page-post'),
            'new_item' => __('New Home Page Post', 'home-page-post'),
            'view' => __('View Home Page Post', 'home-page-post'),
            'view_item' => __('View Home Page Post', 'home-page-post'),
            'search_items' => __('Search Home Page Post', 'home-page-post'),
            'not_found' => __('No Home Page Posts found', 'home-page-post'),
            'not_found_in_trash' => __('No Home Page Posts found in Trash', 'home-page-post')
        ),
